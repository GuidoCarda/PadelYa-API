...
namespace padelya_api.Migrations
{
    ...
    [Migration("20251215191350_AddRankingEntryPersonRelation")]
    partial class AddRankingEntryPersonRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RolCompositePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            PermissionComponentId = 73,
                            RoleId = 100
                        },
                        new
                        {
                            PermissionComponentId = 74,
                            RoleId = 100
                        },
                        new
                        {
                            PermissionComponentId = 75,
                            RoleId = 100
                        },
                        new
                        {
                            PermissionComponentId = 76,
                            RoleId = 100
                        },
                        new
                        {
                            PermissionComponentId = 77,
                            RoleId = 100
                        },
                        new
                        {
                            PermissionComponentId = 78,
                            RoleId = 100
                        },
                        new
                        {
                            PermissionComponentId = 79,
                            RoleId = 100
                        },
                        new
                        {
                            PermissionComponentId = 80,
                            RoleId = 100
                        },
                        new
                        {
            ...
            modelBuilder.Entity("padelya_api.Models.SimplePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Name = "order:view_all",
                            PermissionType = "Simple",
                            Description = "Permite ver todos los pedidos de clientes",
                            DisplayName = "Ver todos los pedidos",
                            ModuleId = 12
                        },
                        new
                        {
                            ...
                            PermissionType = "Simple",
                            Description = "Permite cambiar el estado de un pedido",
                        ...
                        new
                        {
                            ...
                            Name = "order:view_own",
                            PermissionType = "Simple",
                            Description = "Permite ver el historial de pedidos propios",
                            DisplayName = "Ver pedidos propios",
                            ModuleId = 12,
                            RequiredEntity = "Player"
                        },
                        new
                        {
                            ...
                            Name = "order:create",
                            PermissionType = "Simple",
                            Description = "Permite realizar una compra (checkout)",
                        ...
                        new
                        {
                            ...
                            Name = "cart:add",
                            PermissionType = "Simple",
                            Description = "Permite agregar productos al carrito",
                        ...
                        new
                        {
                            ...
                            Name = "cart:remove",
                            PermissionType = "Simple",
                            Description = "Permite quitar productos del carrito",
                        ...
                        new
                        {
                            ...
                            Name = "cart:update",
                            PermissionType = "Simple",
                            Description = "Permite cambiar cantidades en el carrito",
                            DisplayName = "Modificar carrito",
                            ModuleId = 12,
                            RequiredEntity = "Player"
                        },
                        new
                        {
                            ...
                            Name = "cart:view",
                            PermissionType = "Simple",
                            Description = "Permite ver el carrito de compras",
            ...
            modelBuilder.Entity("padelya_api.Models.Annual.RankingEntry", b =>
                {
                    ...
                    b.HasOne("padelya_api.Models.Person", "Player")
                        .WithMany()
                        .HasForeignKey("PlayerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("padelya_api.Models.Challenge.Challenge", b =>
                {
                    b.HasOne("padelya_api.Models.Booking", "Booking")
                        .WithMany()
            ...
            modelBuilder.Entity("padelya_api.Models.Lesson.LessonRoutineAssignment", b =>
                {
                    b.HasOne("padelya_api.Models.Teacher", "AssignedByTeacher")
                        .WithMany()
                    ...
                    b.HasOne("padelya_api.Models.Class.Routine", "Routine")
                        .WithMany()
                        .HasForeignKey("RoutineId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("padelya_api.Models.Tournament.TournamentMatch", b =>
                {
                    ...
                    b.HasOne("padelya_api.Models.Tournament.Couple", "WinnerCouple")
                        .WithMany()
                        .HasForeignKey("WinnerCoupleId")
                        .OnDelete(DeleteBehavior.Restrict);
