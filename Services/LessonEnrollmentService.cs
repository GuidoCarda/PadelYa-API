    ...
    private async Task<Preference> CreateMercadoPagoPreference(LessonEnrollment enrollment, decimal amount, int personId)
    {
      try
      {
        ...
        var request = new PreferenceRequest
        {
          ...
          {
            Success = $"{_configuration["AppSettings:FrontBaseUrl"]}/lessons/payment/success",
            Failure = $"{_configuration["AppSettings:FrontBaseUrl"]}/lessons/payment/failure",
            Pending = $"{_configuration["AppSettings:FrontBaseUrl"]}/lessons/payment/pending"
          },
